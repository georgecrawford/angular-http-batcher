(function () {
     ...
     */
    NpmBatchRequestAdapter.prototype.buildRequest = function buildRequest(
        requests,
        config
    ) {
        var requestIndex;
     ...
     *  the rawResponse
     */
    NpmBatchRequestAdapter.prototype.parseResponse = function parseResponse(
        requests,
        rawResponse
    ) {
        var requestIndex;
     ...
     *  otherwise
     */
    NpmBatchRequestAdapter.prototype.canBatchRequest = function canBatchRequest(
        request
    ) {
        return true;
    };
